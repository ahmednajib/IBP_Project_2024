...
<aside class="main-sidebar sidebar-dark-primary elevation-4"style="background-color: #191717">
    <!-- Brand Logo -->
    <a href="{{url('admin/dashboard')}}" class="brand-link" style="background-color: #191717" >
